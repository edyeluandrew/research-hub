  ...
  <section className="py-10 md:py-12 bg-dark-200 border-b border-gray-800/50">
    <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-5">
      <div className="text-center max-w-3xl mx-auto mb-8">
        ...
        <p className="text-sm font-semibold text-gold-500">{SITE.brandPromise}</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4 md:gap-5 mb-6">
        {CARDS.map(({ icon: Icon, label, text }) => (
          <article
            key={label}
            className="rounded-xl border border-gray-800 bg-dark-100 p-5 md:p-6"
          >
      ...
      <div className="rounded-xl border border-gold-500/20 bg-gold-500/5 px-5 py-4 md:px-6 md:py-5 text-center">
        <p className="text-xs font-semibold uppercase tracking-wider text-gold-500 mb-1">
          Our Philosophy
        </p>
