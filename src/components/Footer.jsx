  ...
  const conversationOptions = [
    {
      ...
      action: () => window.open('mailto:betatechlabs10@gmail.com', '_blank'),
    ...
    },
    {
      ...
      action: () => window.open('https://wa.me/256764331334', '_blank'),
    ...
    },
    {
      ...
      action: () => window.open('tel:+256791018086', '_blank'),
    ...
    <>
      ...
      {showConversationOptions && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-dark-100 border border-gold-500/30 rounded-2xl shadow-2xl max-w-md w-full mx-auto transform animate-scale-in">
            {/* Modal Header */}
            ...
            {/* Modal Footer */}
            <div className="p-4 border-t border-gray-700 bg-dark-200/50 rounded-b-2xl">
